...
### Rollup Protocol (Unzen)

The live rollup: proposal inbox, preconfirmation routing, address resolvers, and the proof verifier set. `ZkRequiredVerifier` is the inbox's `proofVerifier`; it accepts two sub-proofs only if at least one is a ZK proof.

| Contract              | Address                                      |
| --------------------- | -------------------------------------------- |
| Inbox (proxy)         | `0x6f21C543a4aF5189eBdb0723827577e1EF57ef1f` |
...
| ZkRequiredVerifier (impl)  | `0x7284aaC05555Ae6559bdAd8B4221eC9584254Eec` |
| SgxVerifierGeth (impl)     | `0x41e79EB4F03aBB5DF8716B759528dc5d8f6a84Ee` |
| SgxVerifierReth (impl)     | `0x9D3C595BFf6Ff7D2b2CbdEcF94aD917eB2fCFFd8` |
| Risc0Verifier (impl)       | `0x059dAF31F571da48Ab4e74Ae12F64f907681Cd8b` |
| SP1Verifier (impl)         | `0x73A0Db393ef87ce781ac7957bE10D6628432100F` |

<details>
<summary>Legacy</summary>

Legacy Contracts that have since been deprecated from the protocol. Kept here for historical reference and for any integrations still reading from the old inbox.
