...
| **Liveness bond** | Inbox (returned after proving) | TAIKO tokens locked when submitting a proposal. Returned once the proposal range has been proved (which finalizes it under Unzen). |
...
Under Unzen, a single proposal can carry many L2 blocks, amortizing the L1 gas cost across all included blocks. This makes small, frequent blocks economically viable -- an important property for preconfirmations.
