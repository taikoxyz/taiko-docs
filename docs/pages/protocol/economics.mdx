...
:::info
The liveness bond is not a cost in the typical sense -- it is returned to the proposer after successful proof verification. However, it represents locked capital and creates an opportunity cost.
:::
