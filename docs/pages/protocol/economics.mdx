...
|------|---------|-------------|
| **L1 gas fee** | Ethereum L1 | Gas cost of calling `propose` on the Inbox smart contract to submit the batch on-chain. |
...
| **Liveness bond** | Inbox (returned after verification) | TAIKO tokens locked when proposing a batch. Returned once the batch is proved and verified. |
