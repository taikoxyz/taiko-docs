...
Under the **Unzen** architecture, proposers interact with the **Inbox** contract deployed on Ethereum L1. The process works as follows:
...
:::info
Under the Pacaya fork, blocks were proposed in **batches** rather than individually. Unzen switches to **proposal-based derivation** around the separate `Inbox`, while keeping Ethereum L1 as the ordering layer.
:::
