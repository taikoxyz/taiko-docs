# Unzen Fork [Protocol fork introducing block-level zk gas metering.]

Unzen introduces **zk gas** as a protocol-level budget for proving work. Instead of limiting blocks only by ordinary EVM gas, Unzen adds a separate weighted gas metric that reflects how expensive different opcodes and precompiles are to prove.
